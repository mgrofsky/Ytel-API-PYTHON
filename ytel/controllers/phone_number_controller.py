...
"""
    ytel.controllers.phone_number_controller
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    phone_number -- string -- A valid Ytel comma separated
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    phone_number -- string -- A valid Ytel 10-digit phone
                        number (E.164 format).
                    response_type -- string -- Response type format xml or
                        json
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    sms_fallback_method -- HttpActionEnum -- The HTTP method
                        Ytel will use when URL requested if the SmsUrl is not
                        available.
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    hangup_callback_method -- HttpActionEnum -- The HTTP
                        method Ytel will use when requesting the
                        HangupCallback URL.
                    heartbeat_url -- string -- URL that can be used to monitor
                        the phone number.
                    heartbeat_method -- HttpActionEnum -- The HTTP method Ytel
                        will use when requesting the HeartbeatUrl.
                    sms_url -- string -- URL requested when an SMS is
                        received.
                    sms_method -- HttpActionEnum -- The HTTP method Ytel will
