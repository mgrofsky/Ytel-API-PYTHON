...
class PhoneNumberController(BaseController):
    ...
    def create_available_numbers(self,
        ...
        Args:
            numbertype (NumbertypeEnum): Number type either SMS,Voice or all
    ...
    def create_list_numbers(self,
        ...
        Args:
            ...
            number_type (NumberType14Enum, optional): The capability supported
    ...
    def create_bulk_buy_numbers(self,
        ...
        Args:
            number_type (NumberType15Enum): The capability the number
                supports.
