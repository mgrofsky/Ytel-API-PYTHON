...
"""
    ytelapiv3.controllers.call_controller
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    play_dtmf -- string -- DTMF digits to play to the call.
                        0-9, #, *, W, or w
                    play_dtmf_direction -- PlayDtmfDirectionEnum -- The leg of
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    status_call_back_url -- string -- URL that can be
                        ...
                        call is finished.
                    stats_call_back_method -- string -- Specifies the HTTP
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    url -- string -- URL the in-progress call will be
                        redirected to
                    method -- string -- The method used to request the above
                        Url parameter
                    status -- Status24Enum -- Status to set the in-progress
                        call to
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    call_back_url -- string -- URL consulted after the
                        recording completes
                    fileformat -- FileformatEnum -- Format of the recording
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    group_confirm_key -- string -- Define the DTMF that the
                        ...
                        Values : 0-9, #, *
                    group_confirm_file -- GroupConfirmFileEnum -- Specify the
                        audio file you want to play when the called party
                        picks up the call
                    method -- string -- Specifies the HTTP method used to
                        request the required URL once call connects.
                    status_call_back_url -- string -- URL that can be
                    ...
                    fall_back_method -- string -- Specifies the HTTP method
                    ...
                    heart_beat_method -- string -- Specifies the HTTP method
                    ...
                    record_call_back_method -- string -- Method used to
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    if_machine_url -- string -- URL requested when
                        IfMachine=continue
                    if_machine_method -- string -- Method used to request the
                        IfMachineUrl.
