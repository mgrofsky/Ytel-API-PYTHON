...
class CallController(BaseController):
    ...
    def create_play_audio(self,
        ...
        Args:
            ...
            direction (DirectionEnum, optional): The leg of the call audio
                will be played to
    ...
    def create_record_call(self,
        ...
        Args:
            ...
            record (bool): Set true to initiate recording or false to
                terminate recording
            direction (Direction4Enum, optional): The leg of the call to
                record
    ...
    def create_interrupt_call(self,
        ...
        Args:
            ...
            method (string, optional): The method used to request the above
                Url parameter
            status (StatusEnum, optional): Status to set the in-progress call
                to
