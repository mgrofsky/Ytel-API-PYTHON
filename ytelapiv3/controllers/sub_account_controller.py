...
"""
    ytelapiv3.controllers.sub_account_controller
...
class SubAccountController(BaseController):
    ...
    def create_user_subaccountactivation(self,
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    m_activate -- MActivateEnum -- 0 to suspend or 1 to
                        activate
        ...
        _form_parameters = {
            ...
            'mActivate': options.get('m_activate', None)
        }
        ...
        Args:
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    sub_account_sid -- string -- The SubaccountSid to be
                        deleted
                    merge_number -- MergeNumberEnum -- 0 to delete or 1 to
