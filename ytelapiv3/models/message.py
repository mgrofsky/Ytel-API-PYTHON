...
import ytelapiv3.models.template_data
...
class Message(object):
    ...
    def from_dictionary(cls,
        ...
        template_data = ytelapiv3.models.template_data.TemplateData.from_dictionary(dictionary.get('TemplateData')) if dictionary.get('TemplateData') else None
