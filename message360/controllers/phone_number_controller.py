    ...
    def update_phone_number(self,
        ...
        Args:
            ...
            voice_url (string, optional): URL requested once the call
                connects
            voice_method (HttpMethodEnum, optional): TODO: type description
                here. Example: 
            voice_fallback_url (string, optional): URL requested if the voice
                URL is not available
            voice_fallback_method (HttpMethodEnum, optional): TODO: type
                description here. Example: 
            hangup_callback (string, optional): TODO: type description here.
                Example: 
            hangup_callback_method (HttpMethodEnum, optional): TODO: type
                description here. Example: 
            heartbeat_url (string, optional): URL requested once the call
                connects
            heartbeat_method (HttpMethodEnum, optional): URL that can be
                requested every 60 seconds during the call to notify of
                elapsed time
            sms_url (string, optional): URL requested when an SMS is received
            sms_method (HttpMethodEnum, optional): TODO: type description
                here. Example: 
            sms_fallback_url (string, optional): URL requested once the call
                connects
            sms_fallback_method (HttpMethodEnum, optional): URL requested if
